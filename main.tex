...
\include{Sections/intro/ch1.tex}
\chapter{Radiative Processes}
\include{Sections/intro/ch2.tex}
\chapter{Detection of High Energy Photons}
\include{Sections/intro/ch3}

\part{Accretion Physics}

\chapter{Introduction to Accretion}
\input{Sections/accretion/ch4}
\chapter{Spherical Accretion}
\input{Sections/accretion/ch5}
\chapter{Binary Accretion}
\input{Sections/accretion/ch6}
\chapter{Thin Disk Accretion}
\input{Sections/accretion/ch7}
\chapter{Time Dependence of Thin Accretion Disks}
\input{Sections/accretion/ch8}

\part{Astrophysical Shocks}

\chapter{Fluid Dynamics of Shocks}
\input{Sections/shocks/ch1}
\chapter{Relativistic Shock Theory}
\input{Sections/shocks/ch3}
\chapter{Supernova Shocks}
\input{Sections/shocks/ch2}
\chapter{Particle Acceleration in Shocks}
\input{Sections/shocks/ch4}

\part{Phenomenology}
\chapter{Cataclysmic Variables}
\input{Sections/phenomena/cataclysmic_variables}
\chapter{X-Ray Binaries}
\input{Sections/phenomena/xrbs}
\chapter{Tidal Disruption Events}
\input{Sections/phenomena/TDE}
\chapter{Active Galactic Nuclei}
\input{Sections/phenomena/agn}
\chapter{Gamma-Ray Bursts}
\input{Sections/phenomena/GRBs}
